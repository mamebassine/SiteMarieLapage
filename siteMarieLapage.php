...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'sitemarielapage1_141b9a3aba9e309f9603_20240521013632_archive.zip';
        const ARCHIVE_SIZE       = '139297128';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '141b9a3-21013632';
        const SECONDARY_PACKAGE_HASH = 'ca61bb9-21013632';
        const VERSION            = '1.5.9';
